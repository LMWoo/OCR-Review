...
3. [FASText](https://www.cv-foundation.org/openaccess/content_iccv_2015/papers/Busta_FASText_Efficient_Unconstrained_ICCV_2015_paper.pdf)는 Stroke extraction을 위한 FAST감지기를 개조 및 수정한 fast text dectection system
...
3. [Tian](https://arxiv.org/pdf/1609.03605.pdf) 등은 수직 anchors를 발전시키고, 수평의 text lines를 감지하기 위해 CNN-RNN모델을 구성함
